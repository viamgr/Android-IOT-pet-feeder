...
class GetConfiguredDevice @Inject constructor(
    coroutinesDispatcherProvider: CoroutinesDispatcherProvider,
    private val deviceRepository: DeviceRepository,
) : UseCase<Unit, Device?>(coroutinesDispatcherProvider.io) {
    override suspend fun execute(parameters: Unit): Device? {
        return deviceRepository.getAll().firstOrNull()
    }
}